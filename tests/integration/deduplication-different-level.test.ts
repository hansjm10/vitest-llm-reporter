...
describe('Integration: Same Log Different Level Handling', () => {
  ...
  describe('Different log levels should NOT be deduplicated', () => {
    it('should keep both debug and info logs with same message', async () => {
    ...
    it('should keep both info and warn logs with same message', async () => {
    ...
    it('should keep both warn and error logs with same message', async () => {
    ...
    it('should keep all different levels with same message', async () => {
  ...
  describe('Mixed same and different levels', () => {
    it('should deduplicate within same level but not across levels', async () => {
    ...
    it('should handle interleaved messages at different levels', async () => {
  ...
  describe('Statistics for different levels', () => {
    it('should count unique logs per level correctly', async () => {
    ...
    it('should maintain separate counts for each level', async () => {
  ...
  describe('Source tracking with different levels', () => {
    it('should track sources separately for each level', () => {
      ...
      const debugEntry = summary.entries.find((e) => e.level === 'debug' && e.message === message)
      const infoEntry = summary.entries.find((e) => e.level === 'info' && e.message === message)
      const warnEntry = summary.entries.find((e) => e.level === 'warn' && e.message === message)
