...
export class MetricsAggregator {
  ...
  aggregateSummary(
    ...
    return {
      ...
      averageTokensPerFailure: totalFailed > 0 ? Math.round(
        fileMetrics
  ...
  calculateSectionPercentages(
    ...
    for (const section of Object.keys(sections) as MetricSection[]) {
      percentages[section] = totalTokens > 0 
  ...
  static mergeSections(
    ...
    return {
      ...
      details: section1.details && section2.details ? {
        characterCount: (section1.details.characterCount || 0) + (section2.details.characterCount || 0),
